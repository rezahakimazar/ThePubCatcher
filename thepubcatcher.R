...
INPUT_CSV <- "W:/HiWi ManyAnalysis/batch1.csv"
SJR_CSV   <- "W:/HiWi ManyAnalysis/sjr.csv"
OUT_DIR   <- "W:/HiWi ManyAnalysis/outputs_scholar_clean"
...
eeg_tagged |> 
  ...
  write.csv("W:/HiWi ManyAnalysis/sample_dataset.csv")
